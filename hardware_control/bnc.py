...
def gigatronics_bnc_output(freq_GHz,power_dBm ,bnc_addr='USB0::0x03EB::0xAFFF::141-216340000-0292::INSTR'):
...
def set_bnc_output(freq_GHz, power_dBm,\
    ...
    try:
        ...
        bnc_handle.close()
##END set_bnc_output
def output_sinusoidal_signal(ssm_freq, amp, phase, duration, bnc_addr='GPIB0::3::INSTR'):
    try:
        bnc_handle = rm.open_resource(bnc_addr)
...
def set_noise_voltage(noise,bnc_addr='USB0::0x03EB::0xAFFF::141-216340000-0292::INSTR'):
    try:
        bnc_handle = rm.open_resource(bnc_addr)
...
def turn_on_and_off_bnc_output(bnc_addr='USB0::0x03EB::0xAFFF::421-4385A0002-0619::INSTR', RF_out='on'):
    bnc_handle=rm.open_resource(bnc_addr)
    try:
        if RF_out=='on':
...
def set_DC_output(bnc_addr='USB0::0x03EB::0xAFFF::421-4385A0002-0619::INSTR', voltage=0.022):
    bnc_handle=rm.open_resource(bnc_addr)
    try:
