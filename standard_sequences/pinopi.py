...
def pi_nopi_ge(
    ...
    """
    This function should run the pipi pi nopi sequence for a qubit on the ge manifold, using the qubit's properties.
...
def pi_nopi_ef(
    ...
    """
    This function should run the pipi pi nopi sequence for a qubit on the ef manifold, using the qubit's properties.
